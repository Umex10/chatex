...
/**
 * MapStruct mapper interface for converting User entities to FollowDto responses.
 * Used when returning follower/following lists that include follow-status badge flags.
...
public interface FollowMapper {
   ...
   * The badge flags ({@code userFollowingTarget}, {@code targetFollowingUser}) are
